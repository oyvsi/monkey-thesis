...
Selvskreven kildekode er lagt ved under dette vedlegget. Innholder plugins og generering av host-er script, init-script, SQL brukeroppretting(ikke skrevet selv), differanse på endrede plugin-er.
