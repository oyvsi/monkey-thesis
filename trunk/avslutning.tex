...
Både scriptet for å sjekke hvor mye minne en MySQL Cluster node har brukt og scriptet for å synknronisere kontakt-objekter fra Active Directory ble lagt ut på Internett under en GPL-lisens. Disse ble lagt ut på Nagios Exchange og Monitoring Exchange etter godkjenning fra oppdragsgiver. På begge sidene har vi selv funnet flere av plugin-ene, og håper at andre får nytte av vårt arbeid. 
