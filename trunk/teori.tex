...
For en utrulling i den skalen som vil være aktuelt for IKT-avdelingen vil ikke nettverkstrafikken være noen stor faktor. Selv med 1000-enheter som overvåkes over SSH, der hver kjører 1000 sjekker, vil den totale båndbreddebruken være gjennomsnittlig:
\begin{equation}
\frac{8.50kB(kilobytes)\times\frac{60}{5}(1000\times100)}{3600}\times8=22,14Mb/s(megabit per sekund).
\end{equation}
\begin{lstlisting}
#!/usr/bin/env bash
