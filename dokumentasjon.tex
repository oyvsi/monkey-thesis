...
I utrullingsfaser vil det være naturlig å legge til mange hosts i samme slengen. Ved å bruke "gen.bash" scriptet spares tid samtidig som scriptet sørger for å generere hostfilene syntaktisk korrekte.

Scriptet genererer hosts med atributtene  ``hostname'', ``address'', ``hostgroup'' og ``generic''. Hosts uten hostgroup eller generic supplert, vil bruke standardverdier definert i scriptet mens hostname og address er obligatrisk å vil generere en feil.

Eksemplet under viser hvordan scriptet kjøres, samtidig som linjenummer skrives ut dersom informasjon som er obligatorsk mangler.
\begin{lstlisting}
