...
For en utrulling i den skalen som vil være aktuelt for IKT-avdelingen vil ikke nettverkstrafikken være noen stor faktor. Selv med 1000-enheter som overvåkes over SSH, der hver kjører 1000 sjekker, vil den totale båndbreddebruken være gjennomsnittlig (8.5kB(60/5)*(1000*100))/3600*8 = 22,14Mb/s.
\begin{lstlisting}
#!/usr/bin/env bash
