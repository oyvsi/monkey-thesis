...
Icinga er en fork av Nagios, og har blitt utviklet videre siden 2004. Konfigurasjoner, plugin-er og addon-er er kompatible med det som benyttes for Nagios. Forskjellen er selve arkitekturen som i Icinga består av tre separate deler, og abstraksjon mot databaselaget. 
...
\end{equation}
På et gigabit-nettverk, som i tillegg er full duplex, vil ikke dette være nevneverdig. Icinga vil forsøke å fordele sjekkene utover slik at lasten på Icinga-serveren og enhenetene som overvåkes blir minst mulig /cite http://docs.icinga.org/latest/en/checkscheduling.html, men i praksis blir ikke dette helt jevnt fordelt, tallet kan derfor bli noe høyere.
