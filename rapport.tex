...
% Ikke for vedlegg
\lstdefinestyle{example} {language=sh,frame=single,numbers=none,xleftmargin=3em,framexrightmargin=-2em,framexbottommargin=4pt,backgroundcolor={}}
...
\noindent\rule{\textwidth}{0.4pt}
\verbatiminput{vedlegg/database_mail.txt}
\clearpage
